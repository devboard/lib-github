...
/**
 * @see \spec\DevboardLib\GitHub\PullRequest\PullRequestUpdatedAtSpec
 * @see \Tests\DevboardLib\GitHub\PullRequest\PullRequestUpdatedAtTest
 */
class PullRequestUpdatedAt extends DateTime
{
