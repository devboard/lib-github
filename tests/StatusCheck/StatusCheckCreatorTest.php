...
/**
 * @covers \DevboardLib\GitHub\StatusCheck\StatusCheckCreator
 * @group  unit
 */
class StatusCheckCreatorTest extends TestCase
{
    /** @var AccountId */
    private $userId;
    ...
    public function setUp(): void
    {
        ...
        $this->sut       = new StatusCheckCreator(
    ...
    public function testDeserialize(): void
    {
        ...
        self::assertEquals($this->sut, StatusCheckCreator::deserialize(json_decode($serialized, true)));
    }
}
