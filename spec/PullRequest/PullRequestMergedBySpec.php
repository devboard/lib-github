...
use DevboardLib\GitHub\PullRequest\PullRequestMergedBy;
...
class PullRequestMergedBySpec extends ObjectBehavior
{
    ...
    public function it_can_be_serialized(UserId $userId, UserLogin $login, AccountType $type, UserAvatarUrl $avatarUrl)
    {
