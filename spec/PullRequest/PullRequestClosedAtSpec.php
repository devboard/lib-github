...
class PullRequestClosedAtSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(PullRequestClosedAt::class);
    ...
    {
        $this->deserialize('2018-01-01T11:22:33+00:00')->shouldReturnAnInstanceOf(PullRequestClosedAt::class);
    }
}
