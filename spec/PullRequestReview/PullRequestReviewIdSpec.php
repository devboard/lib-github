...
class PullRequestReviewIdSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(PullRequestReviewId::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(PullRequestReviewId::class);
    }
}
