...
class StatusCheckCreatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(StatusCheckCreator::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(StatusCheckCreator::class);
    }
}
